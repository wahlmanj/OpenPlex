...
script AppDelegate
    ...
    on buttonhandlerghostpreview_(sender)
        set theURL to "https://www.youtube.com/watch?v=c5YuJErfOow"
        tell application "Safari" to make new document with properties {URL:theURL}
    end buttonhandlerghostpreview_
    
    on buttonhandlerwahlmanjpreview_(sender)
        set theURL to "https://www.youtube.com/watch?v=i9aULmUIBtU"
        tell application "Safari" to make new document with properties {URL:theURL}
    end buttonhandlerwahlmanjpreview_
